...
from utils.get_training_data_2D import get_data_EX2D2_thermomech_actuator_two_phase_source as get_data
...
if __name__ == "__main__":
    ...
    s = [0.0,-4.5e-8] # simulated body heat source for each material phase (positive means heat generation; otherwise means heat sink from the body)
    kappa = [1.0e-8, 9.07e-5] # thermal conductivity: W/(K um)
    alpha = [1.5e-5, 1.5e-5] # thermal expansion coefficient:
