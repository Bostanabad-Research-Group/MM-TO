...
from utils.get_training_data_3D import get_data_EX3D4 as get_data
...
Nely = 60 # number of elements along y to define training dataset
Nelz = 15 # number of elements along y to define training dataset
...
# random_state = [1,3,5,7,11,13,15]
random_state = [9,17,19]
...
if basis == 'PGCAN3D':
    ...
    res = [22,22,6] # only for PGCAN3D [x,y,z]
...
if basis_rho == 'PGCAN3D':
    ...
    NN_config_rho['res'] = [22,22,6] # only for PGCAN3D [x,y,z]
    ...
    NN_config_rho['kernel_size'] = [4,4,1]
else:
...
for i, state in enumerate(random_state, start=8):
