...
from utils.get_training_data_2D import get_data_EX2D1 as get_data
...
costfrac_f = 0.4 # final mass fraction
...
# coarse mesh
Nelx = 200 # number of elements along x to define training dataset
...
wp = 0.0 # weight factor for cost constraint    
